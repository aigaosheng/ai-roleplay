...
from langchain.utilities import DuckDuckGoSearchAPIWrapper as GoogleSearchAPIWrapperLocal
...
class WebResearchRetriever(BaseRetriever):
    ...
    search: GoogleSearchAPIWrapperLocal = Field(..., description="Google Search API Wrapper")
    ...
    def from_llm(
        ...
        llm: BaseLLM,
        search: GoogleSearchAPIWrapperLocal, #DuckDuckGoSearchAPIWrapper, #GoogleSearchAPIWrapper,
    ...
    def _get_relevant_documents(
        ...
        *,
        ...
        for query in questions:
            ...
            for res in search_results:
                if res.get("link", None):
                    if res["link"].lower().endswith(".pdf"):
                        continue
        ...
        if new_urls:
            ...
            retriever = BM25Retriever.from_documents(docs) #Fro BM25
